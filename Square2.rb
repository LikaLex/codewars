#Another Kata testing an whether all elements of an array are square, although this time the array 
#can be a multidemtional array with any number of dimensions. Your task - Write a function that checks whether 
#all elements in a multidimensional array are square numbers. 
